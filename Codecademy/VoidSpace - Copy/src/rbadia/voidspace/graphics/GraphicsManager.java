...
public class GraphicsManager {
	...
	public GraphicsManager(){
		...
		try {
			...
			this.holeImg = ImageIO.read(getClass().getResource("/rbadia/voidspace/graphics/hole.png"));
	...
	/**
	 * Draws a hole image to the specified graphics canvas.
	 * @param hole the hole to draw
	 * @param g2d the graphics canvas
	 * @param observer object to be notified
	 */
	public void drawHole(BlackHole hole, Graphics2D g2d, ImageObserver observer) {
		g2d.drawImage(holeImg, hole.x, hole.y, observer);
	}
}
